...
//    }
    ...
    @Override
    public void writeToFileWithConditionToDonwload(ConditionToDowbload conditionToDowbload, String fileName){
        String separator = System.lineSeparator();
        String path = "DownloadData";
        String delimeter = conditionToDowbload.getDelimeter();
        ...
        Set<String> checkedData = new HashSet<>(conditionToDowbload.getSelected());
        try (FileWriter fileWriter = new FileWriter(file);
             BufferedWriter bufferedWriter = new BufferedWriter(fileWriter)) {

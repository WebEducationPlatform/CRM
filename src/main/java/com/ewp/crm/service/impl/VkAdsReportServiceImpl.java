...
public class VkAdsReportServiceImpl {
    private String adsClientId = "1605137078";
    private String appClientId = "6886597";
    ...
    public String vkAdsBudgetUri() {
        StringBuilder stb = new StringBuilder(vkAPI).append("ads.getBudget")
                .append("?account_id=").append(adsClientId)
                .append("&version=").append(adsClientId)
                .append("&access_token=").append(access_token);
        return stb.toString();
    }
    ...
    public String vkAppGetTokenUri() {
        StringBuilder stb = new StringBuilder("https://oauth.vk.com/authorize")
                ...
                .append("&display=page&redirect_uri=").append(vkAppRedirect_uri)
    ...
    public String getVKAdsSpentMoney() throws JSONException {
    ...
    public static void main(String[] args) throws JSONException {
        VkAdsReportServiceImpl vkAdsReport = new VkAdsReportServiceImpl();
      ...
      /*  String baltest = "{\"response\":\"15.00\"}";
        ...
        System.out.println(vkAdsReport.getVkAdsBalance());
        System.out.println(vkAdsReport.getVKAdsSpentMoney());
    }

...
public class IncomeStringToClient {
    ...
    private static String prepareForm(String text) {
        return text
                ...
                .replaceAll("(N|n)(A|a)(M|m)(E|e)[\\s]?.?:[^:]", KEYS.NAME + ":")
                .replaceAll("(И|и)(М|м)(Я|я)[\\s]?.?:[^:]", KEYS.NAME + ":")
                .replaceAll("(P|p)(H|h)(O|o)(N|n)(E|e)[\\s]?.?:[^:]", KEYS.PHONE + ":")
                .replaceAll("(Т|т)(Е|е)(Л|л)(Е|е)(Ф|ф)(О|о)(Н|н)[\\s]?.?:[^:]", KEYS.PHONE + ":")
                .replaceAll("(Г|г)(О|о)(Р|р)(О|о)(Д|д)[\" \"]?.?:[^:]", KEYS.CITY + ":")
                .replaceAll("(C|c)(I|i)(T|t)(Y|y)[\\s]?.?:[^:]", KEYS.CITY + ":")
                .replaceAll("(C|c)(O|o)(U|u)(N|n)(T|t)(R|r)(Y|y)[\\s]?.?:[^:]", KEYS.COUNTRY + ":")
                .replaceAll("(С|с)(Т|т)(Р|р)(А|а)(Н|н)(А|а)[\\s]?.?:[^:]", KEYS.COUNTRY + ":")
                .replaceAll("(С|с)(Т|т)(Р|р)(А|а)(Н|н)(И|и)(Ц|ц)(А|а)[^:]*:", KEYS.PAGE + ":")
                .replaceAll("(E|e)-?(M|m)(A|a)(I|i)(L|l)[\\s]?.?:[^:]", KEYS.EMAIL + ":")

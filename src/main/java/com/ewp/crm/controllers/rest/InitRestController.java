...
public class InitRestController {
    ...
    @Autowired
    public InitRestController(UserService userService, PasswordEncoder passwordEncoder, VKService vkService, ClientService clientService, SlackService slackService) {

...
public class Client implements Serializable {
    ...
    public Client(String name, String lastName, Long vkId) {
        this.name = name;
    ...
    public Client(String name, String lastName, String phoneNumber, String email, byte age, Sex sex, Long vkId) {
        this.name = name;
        this.lastName = lastName;
        this.phoneNumber = phoneNumber;
        this.email = email;
    ...
    public boolean equals(Object o) {
        ...
        if (vkId != client.vkId) return false;

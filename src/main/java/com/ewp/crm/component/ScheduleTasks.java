...
public class ScheduleTasks {
	...
	private void testMessages() {
		...
		String s1 = env.getProperty("messaging.notification.set-comment");//
		String testStr1 = String.format(s1, "blink1", "blin2", "blin3", "blin4");
		String s2 = env.getProperty("messaging.call-records.exception.download-file-not-found");//
		String s3 = env.getProperty("messaging.call-records.unknown-user");//
		String s4 = env.getProperty("messaging.mailing.exception.parse-data");//
		String s5 = env.getProperty("messaging.mailing.set-from-Java-Mentor");//
		String s6 = env.getProperty("messaging.mailing.set-subject-personal-mentor");//
		String s7 = env.getProperty("messaging.mailing.set-subject-crm-notification");//
		String s8 = env.getProperty("messaging.whatsapp.send-error-wrong-phone");//
		String s9 = env.getProperty("messaging.slack.send-error");//
		String s10 = env.getProperty("messaging.user.exception.allready-exist");//
		String s11 = env.getProperty("messaging.user.exception.photo-save-error");//
		String s12 = env.getProperty("messaging.facebook.exception.access-token");//
		String s13 = env.getProperty("messaging.vk.send-ok");//
		String s14 = env.getProperty("messaging.vk.send-by-id-error");//
		String s15 = env.getProperty("messaging.vk.get-report-error");//
		String s16 = env.getProperty("messaging.vk.exception.not-found-member-list");//
		String s17 = env.getProperty("messaging.vk.exception.access-token");//
		String s18 = env.getProperty("messaging.vk.rest.message-send-ok");//
		String s19 = env.getProperty("messaging.skype.call.event-error");//
		String s20 = env.getProperty("messaging.client.exception.exist");//
		String s21 = env.getProperty("messaging.client.history.add-from-whatsapp");//
		String s22 = env.getProperty("messaging.client.rest.wrong-postpone-date");//
		String s23 = env.getProperty("messaging.client.rest.postpone-error");//
		String s24 = env.getProperty("messaging.client.rest.description-error");//
		String s25 = env.getProperty("messaging.client.rest.description-same-error");//
		String s26 = env.getProperty("messaging.client.rest.skype-login-same-error");//
		String s27 = env.getProperty("messaging.client.rest.repeated-client-updated");//
		String s28 = env.getProperty("messaging.client.initRest.updated");//
		String s29 = env.getProperty("messaging.client.email.error-in-field");//
		String s30 = env.getProperty("messaging.client.phone.sms.status-not-found");//
		String s31 = env.getProperty("messaging.client.phone.sms.status-delivered");//
		String s32 = env.getProperty("messaging.client.phone.sms.rest.send-ok");//
		String s33 = env.getProperty("messaging.client.phone.sms.rest.send-error");//
		String s34 = env.getProperty("messaging.client.phone.sms.rest.planned");//
		String s35 = env.getProperty("messaging.client.phone.sms.rest.in-queue");//
		String s36 = env.getProperty("messaging.client.phone.calls.delivery-error");//
		String s37 = env.getProperty("messaging.client.phone.calls.invalid-mobile-phone");//
		String s38 = env.getProperty("messaging.client.phone.calls.incorrect-id");//
		String s39 = env.getProperty("messaging.client.phone.calls.unknown-error");//
		String s40 = env.getProperty("messaging.client.service.repeated");//
		String s41 = env.getProperty("messaging.client.service.socials-not-found-comment");//
		String s42 = env.getProperty("messaging.client.status.exception.allready-exist");
		String s43 = env.getProperty("messaging.client.status.exception.impossible-to-del-first");
		String s44 = env.getProperty("messaging.client.status.exception.deleted-impossible-to-del");
		String s45 = env.getProperty("messaging.client.socials.invalid-link");//
		String testStr = String.format(env.getProperty("messaging.client.socials.invalid-link"), "blink");

...
public class ScheduleTasks {
	...
	private void sendBirthdayMails() {
		...
		String messageBirthDay = "С днем рождения!";
		try {
			messageBirthDay = messageTemplateBirthDay.getOtherText();
		} catch (Exception e) {
			logger.error("Нe установлен шаблон для поздравления с днем рождения", e);
		}

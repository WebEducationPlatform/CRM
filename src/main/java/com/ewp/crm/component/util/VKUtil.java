...
public class VKUtil {
    ...
    public String createGroup(String token) {
    ...
    public String addUsers(String token, String users) {
        String createTargetingGroup = "https://api.vk.com/method/" +
                "%s?" +
                "account_id=%s&" +
                "target_group_id=%s&" +
                ...
                "v=%s";
        return String.format(createTargetingGroup,
                "ads.importTargetContacts", "1604697686", "27161406", users ,token, version
        );
    }
}

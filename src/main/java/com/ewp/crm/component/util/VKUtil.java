...
public class VKUtil {
    ...
    public Client getClientFromVkId(Long id) {
    ...
    public Client parseClientFromMessage(String message) throws ParseClientException {
        ...
        Long vkId;
        try {
            String sM = message.substring(message.indexOf("vk.com/id") + 9);
            vkId = Long.parseLong(sM.substring(0, sM.indexOf("Диалог:")));
        ...
        return new Client(name, lastName, phoneNumber, email, age, sex, vkId);
    }
}
